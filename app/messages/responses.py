...
class GetAllSwitchStatesResponse(Response):
    def __init__(self, states: Dict[str, Union[bool, None]]):
        self.type = "get_all_switch_states_response"
        self.states = states


class GetSwitchStateResponse(Response):
    def __init__(self, name: str, state: Union[bool, None]):
...
class GetAllSensorDataResponse(Response):
    def __init__(
        self,
        sensors: dict[str, Tuple[Union[int, float, None], Union[int, float, None]]],
    ):
...
class GetSensorDataResponse(Response):
    def __init__(
        self,
        name: str,
        data: Union[Tuple[Union[int, float, None], Union[int, float, None]], None],
    ):
